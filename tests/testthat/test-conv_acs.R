...
#   y <- c("readmission1", "readmission2", "readmission3", "readmission4", "readmission5",
#          "readmpodays1", "readmpodays2", "readmpodays3", "readmpodays4", "readmpodays5",
#          "readmrelated1", "readmrelated2", "readmrelated3", "readmrelated4", "readmrelated5",
#          "readmsuspreason1", "readmsuspreason2", "readmsuspreason3", "readmsuspreason4", "readmsuspreason5",
#          "readmrelicd91", "readmrelicd92", "readmrelicd93", "readmrelicd94", "readmrelicd95",
#          "readmrelicd101", "readmrelicd102", "readmrelicd103", "readmrelicd104", "readmrelicd105",
#          "unplannedreadmission1", "unplannedreadmission2", "unplannedreadmission3", "unplannedreadmission4", "unplannedreadmission5",
#          "readmunrelsusp1", "readmunrelsusp2", "readmunrelsusp3", "readmunrelsusp4",  "readmunrelsusp5",
#          "readmunrelicd91",  "readmunrelicd92",  "readmunrelicd93",  "readmunrelicd94",  "readmunrelicd95",
#          "readmunrelicd101", "readmunrelicd102", "readmunrelicd103", "readmunrelicd104", "readmunrelicd105")
#   make_readm_cols(x)
...
testthat::test_that("make_reop_cols works", {
  ...
  y <- c("reoperation1", "reoperation2", "reoperation3",
         "retorpodays",  "retor2podays", "retor3podays",
         "reoporcpt1", "reopor2cpt1",  "reopor3cpt1",
         "retorrelated", "retor2related", "retor3related",
         "reoporicd91",  "reopor2icd91", "reopor3icd91",
         "reopor1icd101", "reopor2icd101", "reopor3icd101")
  make_reop_cols(x)
  testthat::expect_equal(names(x), y)
})
...
testthat::test_that("make_anesthes_other_cols works", {
  ...
  y <- data.table::data.table(anesthes_other = c("General", "General, Spinal", "General, Spinal, MAC/IV Sedation", NA),
                              ...
                              anesthes_other4 = c(NA_character_, NA_character_, NA_character_, NA_character_),
                              anesthes_other5 = c(NA_character_, NA_character_, NA_character_, NA_character_),
                              anesthes_other6 = c(NA_character_, NA_character_, NA_character_, NA_character_),
                              anesthes_other7 = c(NA_character_, NA_character_, NA_character_, NA_character_),
                              anesthes_other8 = c(NA_character_, NA_character_, NA_character_, NA_character_))
