...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/dylanrussellmd/nsqipr.svg?branch=master)](https://travis-ci.com/dylanrussellmd/nsqipr)
...
## Use
  ...
  1. Excute all `.exe` executable files from ACS NSQIP<sup>&copy;</sup> in a single directory (`dir`) (do not change the default file names). 
